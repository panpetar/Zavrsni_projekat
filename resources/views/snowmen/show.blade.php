<x-app-layout>
    ...
    <div class="card" style="width: 18rem;">
        <img src="{{ asset('storage/images/snowmen/' . $product->image_url) }}" class="card-img-top" alt="...">
               <div class="card-body">
        ...
        <div class="col-md-6">
            <a href="{{ route('snowmen.edit',$product->id) }}" class="btn btn-success m-3"><i class="bi bi-pencil-square me-2"></i>Edit</a>
            <form action="{{ route('snowmen.show', $product->id) }}" method="POST">
                @csrf
                @method('DELETE')
